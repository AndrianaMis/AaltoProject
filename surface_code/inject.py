...
from .helpers import extract_round_template, build_circ_by_round_from_generated, extract_round_template_plus_suffix
...
def run_batched_data_anc_plus_m2_(circuit, M_data, M_anc, M2, gate_pairs, data_ids, anc_ids, enable_M0: bool=True, enable_M1: bool= True, enable_M2:bool=True):
    # Build rounds
    from .helpers import build_circ_by_round_from_generated, extract_round_template
    circ_by_round, anc_ids_auto = build_circ_by_round_from_generated(circuit)
    assert sorted(anc_ids) == sorted(anc_ids_auto)
    ...
    prefix, pre_round, meas_round, suffix=extract_round_template_plus_suffix(circuit)
